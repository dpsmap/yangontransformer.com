...
class MaterialWP extends ParadoxFramework {
  ...
  public function checkBlacklist() {
    ...
    if (!empty($this->options->getOption('material-wp-user'))) {
     ...
     */
     ...
     if (!empty($this->options->getOption('material-wp-roles')) && is_array($user->roles)) {        
  ...
  public static function get_uploads_folder($type = 'path') {
    ...
    return $type == 'path' 
      ...
      : (isset($uploads['baseurl']) && $uploads['baseurl'] ? $uploads['baseurl'] : '');
